...
export function AdminLoginScreen({
  ...
  return (
    <main className="relative h-[100dvh] overflow-x-hidden overflow-y-auto overscroll-y-contain bg-[#061015] text-[#d7ffe2] [-webkit-overflow-scrolling:touch]">
      ...
      <div className="relative z-[1] flex min-h-full w-full flex-col items-center justify-center px-6 py-10">
            ...
            <section className="relative border-b border-emerald-500/15 p-8 lg:border-b-0 lg:border-r">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                <div className="rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.04] p-4">
                  ...
                  <p className="mt-3 font-mono text-xl text-cyan-200">
                    HTTPOnly
                  </p>
                </div>
                <div className="rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.04] p-4">
