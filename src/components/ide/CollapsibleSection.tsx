  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onToggle}
        className="flex min-h-10 w-full shrink-0 items-center gap-1.5 px-2 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground transition-[color,background-color] duration-150 ease-out hover:bg-accent/30"
      >
        {isOpen ? (
